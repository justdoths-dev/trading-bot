...
DEFAULT_BASELINE_PATH = Path(
    "logs/research_reports/experiments/candidate_b_vol_adjusted/summary.json"
)
DEFAULT_EXPERIMENT_PATH = Path(
    "logs/research_reports/experiments/candidate_c_asymmetric/c2_moderate/summary.json"
)
DEFAULT_JSON_OUTPUT = Path(
    "logs/research_reports/experiments/candidate_comparison/candidate_b_vs_c_comparison.json"
)
DEFAULT_MD_OUTPUT = Path(
    "logs/research_reports/experiments/candidate_comparison/candidate_b_vs_c_comparison.md"
)


def build_experimental_candidate_bc_comparison_report(
...
def run_experimental_candidate_bc_comparison_report(
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Build a Candidate B vs Candidate C experiment-summary comparison report"
    )
